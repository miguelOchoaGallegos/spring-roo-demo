...
import com.miguelo.examplelogin.web.ClientesCollectionThymeleafController;
import com.miguelo.examplelogin.web.ClientesItemThymeleafController;
import com.miguelo.examplelogin.web.ClientesItemThymeleafLinkFactory;
import com.miguelo.examplelogin.web.reports.ExportingErrorException;
import com.miguelo.examplelogin.web.reports.JasperReportsCsvExporter;
import com.miguelo.examplelogin.web.reports.JasperReportsExporter;
import com.miguelo.examplelogin.web.reports.JasperReportsPdfExporter;
import com.miguelo.examplelogin.web.reports.JasperReportsXlsExporter;
...
privileged aspect ClientesCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void ClientesCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        else if (columnName.equals("apellido")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_apellido", null, "Apellido", locale), "apellido", String.class.getName(), 100);
        }
        else if (columnName.equals("telefonoCelular")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_telefonocelular", null, "Telefono Celular", locale), "telefonoCelular", String.class.getName(), 100);
        }
        else if (columnName.equals("telefonoFijo")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_telefonofijo", null, "Telefono Fijo", locale), "telefonoFijo", String.class.getName(), 100);
        }
        else if (columnName.equals("direccion")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_direccion", null, "Direccion", locale), "direccion", String.class.getName(), 100);
        }
        }
